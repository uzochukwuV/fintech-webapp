      ...
      <div className="bg-white dark:bg-inherit py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-200 sm:text-4xl">Testimonials</h2>
            <p className="mt-2 text-lg leading-8 text-gray-600 dark:text-gray-300">
              Observe and learn from our group of testimonials
            </p>
          </div>
            ...
            {posts.map((post) => (
              <article key={post.id} className="flex max-w-xl flex-col items-start justify-between">
                ...
                <div className="group relative">
                  ...
                  <p className="mt-5 line-clamp-3 text-sm leading-6 dark:text-gray-400 text-gray-600">{post.description}</p>
                </div>
