...
function SubComponent() {
  ...
  return (
    <section className=" px-12 py-10">
      ...
      <div className="flex gap-10 justify-center rounded-2xl bg-slate-50 max-h-screen py-10 mt-6">
        {plans.map((plan) => (
        ...
        <div className=" flex-1 mt-10 space-y-2 flex flex-col justify-end items-start text-end">
          ...
          <Button
            className={cn(
              ...
              props.type == "Silver" && " bg-green-500 text-slate-200"
            )}
          >
            Choose this plan <span className="ps-2 text-green-500"> Now</span>
          </Button>
        </div>
      </div>
    </div>
